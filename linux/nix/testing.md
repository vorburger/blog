...
I've continued to dabble with NixOS [since attending NixCon 2025](../../conferences/FOSDEM-2025.md).
...
and, just like that, you built and started 3 virtual machines, had 2 of them ping each other,
and ran `hello` on the 3rd one - in ~8s!! (On my computer; on 2nd and subsequent runs, 1st is slower - YMMV.)
...
and if you marry this with [`vic/import-tree`](https://github.com/vic/import-tree) then you reach
...
I'm not really sure exactly how to do that yet, but I'll figure it out - given time.)
