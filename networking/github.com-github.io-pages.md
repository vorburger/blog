...
Adjusting it in my [zonefile](https://en.wikipedia.org/wiki/Zone_file) fixed it; phew - disaster 🌋 averted. With ~1h total from detection to mitigation. (Depending on DNS cache, due to 1h TTL.) That's not a bad service IMHO; I'm giving myself 7 stars out of 5 for this quick remediation! 😆
